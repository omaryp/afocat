    ...
    */
    ...
    public function model(array $row)
    {
        ...
        return new Certificate([
            ...
            'fecha_emision' => date('Y-m-d', $row['fecha_emision']),
            'ini_vigencia' => date('Y-m-d',$row['ini_vigencia']),
            'fin_vigencia' => date('Y-m-d',$row['fin_vigencia']),
            'ini_control' => date('Y-m-d',$row['ini_vigencia']),
            'fin_control' => date('Y-m-d',$row['fin_vigencia']),
